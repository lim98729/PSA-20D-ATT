...
// 		eSV_LAST = 74
	...
	public enum ALARM_CODE		// MPC에 1051부터 1400까지 350개가 할당되어 있다.
	{
        ...
        E_SYSTEM_HW_SYSTEM_NOT_INIT = 26,
        E_SYSTEM_HW_IO_NOT_WORKING = 27,
        ...
        E_SF_HEAT_SLUG_WRONG_STATUS = 40,
        E_HD_PLACE_MISSCHECK = 41,
		E_MACHINE_RUN_PRESS_TILT_ERROR = 42,
		E_HDC_P1_FIDUCIAL_CHECKED_FAIL = 43,		// Fiducial이 안보여야 하는데 오히려 보이는 경우
		E_MACHINE_RUN_SENSOR_UNDER_PRESS = 44,
		E_MACHINE_RUN_SENSOR_OVER_PRESS = 45,
		E_MACHINE_RUN_TRAY_REVERSE = 46,
		E_MACHINE_RUN_REFERENCE_OVER = 47,
		E_MACHINE_RUN_NOZZLE_FLATNESS_OVER = 48,
		E_MACHINE_RUN_FORCE_LEVEL_OVER = 49,
		E_MACHINE_RUN_HEAT_SLUG_EMPTY = 50,
		E_MACHINE_RUN_HEAT_SLUG_UNDER_PRESS = 51,
		E_MACHINE_RUN_HEAT_SLUG_OVER_PRESS = 52,
		E_MACHINE_RUN_PEDESTAL_DOWN_TIMEOUT = 53,
        E_MACHINE_RUN_PEDESTAL_UP_TIMEOUT = 54,
        E_MACHINE_RUN_SF_GUIDE_TIMEOUT = 55,
		...
		E_HDC_PACKAGE_THETA_TRESULT_OVER = 74,
		...
		// 각 축의 알람에 대해 개별 정의할 경우 너무 많아지므로 축 이름을 받아와서 출력한다.
