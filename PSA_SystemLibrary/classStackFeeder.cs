		...
		public void control()
		{
			...
			switch (sqc)
			{
				...
				case 2:
                    ...
                    if (reqMode == REQMODE.PUT) { sqc = SQC.PUT; break; }
                ...
                case SQC.PUT + 1:
                    ...
                    {
                        if (readyPosition == 0) errorCheck((int)UnitCodeAxisNumber.SF_Z1, ERRORCODE.SF, sqc, "Z1 Put Mode Error!");
                        else if (readyPosition == 1) errorCheck((int)UnitCodeAxisNumber.SF_Z2, ERRORCODE.SF, sqc, "Z2 Put Mode Error!");
                        break;
                    }
                    ...
                    if (readyPosition == 0)
                    {
                        TubeGuide(UnitCodeSF.SF1, out ret.b1, out ret.message); if (ioCheck(sqc, ret.message)) break;
                        TubeGuide(UnitCodeSF.SF2, out ret.b2, out ret.message); if (ioCheck(sqc, ret.message)) break;
                        Z.IN_N_LIMIT(out limitCheck, out ret.message); if (mpiCheck(Z.config.axisCode, sqc, ret.message)) break;
                    }
                    else if (readyPosition == 1)
                    {
                        TubeGuide(UnitCodeSF.SF3, out ret.b1, out ret.message); if (ioCheck(sqc, ret.message)) break;
                        TubeGuide(UnitCodeSF.SF4, out ret.b2, out ret.message); if (ioCheck(sqc, ret.message)) break;
                        Z2.IN_N_LIMIT(out limitCheck, out ret.message); if (mpiCheck(Z.config.axisCode, sqc, ret.message)) break;
                    }
